...
const (
	...
	NefDataServiceResUriPrefix   = "/nnef-data-service/v1"
)
...
type Configuration struct {
	...
	DsmfUri      string    `yaml:"dsmfUri,omitempty" valid:"optional"`
...
func (c *Config) DsmfUri() string {
	c.RLock()
	defer c.RUnlock()

	return c.Configuration.DsmfUri
}
